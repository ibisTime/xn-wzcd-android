...
public class RequestUtil {
     ...
     * @return
     */
    public static String formatRateDiv(String strAmount) {
        if (TextUtils.isEmpty(strAmount)) {
            return "0.00";
        }

        return scale(
                new BigDecimal(strAmount).divide(new BigDecimal(100), 8, ROUND_DOWN)
                        .toPlainString(),
                4);
     ...
     * @return
     */
    public static String formatRateMul(String strAmount) {
        if (TextUtils.isEmpty(strAmount)) {
            return "0.00";
        }

        return scale(new BigDecimal(strAmount).multiply(new BigDecimal(100)).toPlainString(), 2);
    }
    ...
    public static String formatAmountDiv(String strAmount) {
        ...
        return scale(amount.divide(new BigDecimal(1000), 8, ROUND_HALF_DOWN).toPlainString(), 2);
    }
...
//    }
    ...
    public static String scale(String s, int scale) {
        ...
        DecimalFormat format = new DecimalFormat("0." + fm);
