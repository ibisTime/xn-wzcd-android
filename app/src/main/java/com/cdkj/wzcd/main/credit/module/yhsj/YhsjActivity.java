package com.cdkj.wzcd.main.credit.module.yhsj;
...
import com.cdkj.wzcd.databinding.ActYhsjBinding;
 ...
 */
public class YhsjActivity extends AbsBaseLoadActivity {

    private ActYhsjBinding mBinding;
    ...
    public static void open(Context context, String code) {
        ...
        Intent intent = new Intent(context, YhsjActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.act_yhsj, null, false);
    ...
    private void doRequest() {
        ...
        hashMap.put("bankFkDate", mBinding.dlDate.getText());
        hashMap.put("bankFkNote", mBinding.rlRemark.getText());

        Call call = RetrofitUtils.getBaseAPiService()
                .successRequest("632570", StringUtils.getJsonToString(hashMap));
        ...
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            ...
            protected void onSuccess(IsSuccessModes data, String SucMessage) {
                UITipDialog.showSuccess(YhsjActivity.this, "操作成功", dialogInterface -> {
                    finish();
                });
            }
