package com.cdkj.wzcd.main.credit.module.yhtj;
 ...
 */
public class YhtjActivity extends AbsBaseLoadActivity {

    private ActYhtjBinding mBinding;
    ...
    public static void open(Context context, String code) {
        ...
        Intent intent = new Intent(context, YhtjActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.act_yhtj, null, false);
    ...
    private void doRequest() {
        ...
        hashMap.put("bankCommitDatetime", mBinding.dlDate.getText());
        hashMap.put("bankCommitNote", mBinding.rlRemark.getText());

        Call call = RetrofitUtils.getBaseAPiService()
                .successRequest("632571", StringUtils.getJsonToString(hashMap));
        ...
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            ...
            protected void onSuccess(IsSuccessModes data, String SucMessage) {
                UITipDialog.showSuccess(YhtjActivity.this, "操作成功", dialogInterface -> {
                    finish();
                });
            }
