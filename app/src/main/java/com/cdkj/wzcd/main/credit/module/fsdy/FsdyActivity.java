package com.cdkj.wzcd.main.credit.module.fsdy;
...
import com.cdkj.wzcd.databinding.ActFsdyBinding;
 ...
 */
public class FsdyActivity extends AbsBaseLoadActivity {

    private ActFsdyBinding mBinding;
    ...
    public static void open(Context context, String code) {
        ...
        Intent intent = new Intent(context, FsdyActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.act_fsdy, null, false);
    ...
    private void doRequest() {
        ...
        Call call = RetrofitUtils.getBaseAPiService()
                .successRequest("632581", StringUtils.getJsonToString(hashMap));
        ...
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            ...
            protected void onSuccess(IsSuccessModes data, String SucMessage) {
                UITipDialog.showSuccess(FsdyActivity.this, "操作成功", dialogInterface -> {
                    finish();
                });
            }
