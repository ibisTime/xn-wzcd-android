 ...
 */
public class CreditPledgePageAdapter extends BaseQuickAdapter<CreditPageBean, BaseViewHolder> {

    public CreditPledgePageAdapter(@Nullable List<CreditPageBean> data) {
    ...
    protected void convert(BaseViewHolder helper, CreditPageBean item) {
        ...
        helper.setText(R.id.tv_status, NodeHelper.getNameOnTheCode(item.getPledgeNodeCode()));
