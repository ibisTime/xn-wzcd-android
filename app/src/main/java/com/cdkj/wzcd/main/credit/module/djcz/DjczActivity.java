package com.cdkj.wzcd.main.credit.module.djcz;
...
import com.cdkj.wzcd.databinding.ActDjczBinding;
 ...
 */
public class DjczActivity extends AbsBaseLoadActivity {

    private ActDjczBinding mBinding;
    ...
    public static void open(Context context, String code) {
        ...
        Intent intent = new Intent(context, DjczActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.act_djcz, null, false);
        return mBinding.getRoot();
    }

    @Override
    public void afterCreate(Bundle savedInstanceState) {
        mBaseBinding.titleView.setMidTitle("打件操作");
    ...
    private void doRequest() {
        ...
        hashMap.put("hitPieceDatetime", mBinding.dlDate.getText());
        hashMap.put("hitPieceNote", mBinding.rlRemark.getText());

        Call call = RetrofitUtils.getBaseAPiService()
                .successRequest("632561", StringUtils.getJsonToString(hashMap));
        ...
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            ...
            protected void onSuccess(IsSuccessModes data, String SucMessage) {
                UITipDialog.showSuccess(DjczActivity.this, "操作成功", dialogInterface -> {
                    finish();
                });
            }
