package com.cdkj.wzcd.main.credit.module.ljdj;
...
import com.cdkj.wzcd.databinding.ActLjdjBinding;
 ...
 */
public class LjdjActivity extends AbsBaseLoadActivity {

    private ActLjdjBinding mBinding;
    ...
    public static void open(Context context, String code) {
        ...
        Intent intent = new Intent(context, LjdjActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.act_ljdj, null, false);
        return mBinding.getRoot();
    }

    @Override
    public void afterCreate(Bundle savedInstanceState) {
        mBaseBinding.titleView.setMidTitle("理件打件");
    ...
    private void doRequest() {
        ...
        hashMap.put("rationaleDatetime", mBinding.dlDate.getText());
        hashMap.put("rationaleNote", mBinding.rlRemark.getText());

        Call call = RetrofitUtils.getBaseAPiService()
                .successRequest("632560", StringUtils.getJsonToString(hashMap));
        ...
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            ...
            protected void onSuccess(IsSuccessModes data, String SucMessage) {
                UITipDialog.showSuccess(LjdjActivity.this, "操作成功", dialogInterface -> {
                    finish();
                });
            }
