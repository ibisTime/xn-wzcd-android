...
import com.cdkj.wzcd.databinding.ActivityFabricationDetailBinding;
...
public class FabricationApplyActivity extends AbsBaseLoadActivity {

    private ActivityFabricationDetailBinding mBinding;

    private String code;

    public static void open(Context context, String code) {
        if (context != null) {
            Intent intent = new Intent(context, FabricationApplyActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.activity_fabrication_detail, null ,false);
    ...
    public void apply(){
        ...
        call.enqueue(new BaseResponseModelCallBack<CodeModel>(this) {
            ...
            protected void onSuccess(CodeModel data, String SucMessage) {
                ...
                UITipDialog.showSuccess(FabricationApplyActivity.this, "申请成功", dialogInterface -> {
                    finish();
                });
