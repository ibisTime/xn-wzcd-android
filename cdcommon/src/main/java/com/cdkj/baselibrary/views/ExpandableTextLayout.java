...
/**
 * 收缩TextView https://github.com/Manabu-GT/ExpandableTextView
 */

public class ExpandableTextLayout extends LinearLayout implements View.OnClickListener {

    private static final String TAG = ExpandableTextLayout.class.getSimpleName();
    ...
    private View mExpandCollapseLayout;
    ...
    public void onClick(View view) {
        if (mExpandCollapseLayout.getVisibility() != View.VISIBLE) {
            return;
        }
...
//        mButton.setVisibility(View.GONE);
        mExpandCollapseLayout.setVisibility(View.GONE);
...
//        mButton.setVisibility(View.VISIBLE);
        mExpandCollapseLayout.setVisibility(View.VISIBLE);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.more_down);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.more_down);
        }
